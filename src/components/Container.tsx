...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Vitesh Balusu",
    description: `a Computer Science grad creating unique digital experiences.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.vitesh.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.vitesh.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Vitesh Balusu" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Vitesh" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">VB</span>
        </Link>
